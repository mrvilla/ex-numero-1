...
var openClass="is-open";$mobileButton.on("click",function(e,target){var $target=(0,_veamsQuery2.default)(target);// cache element that youll need later
var headerMenuList="[data-js-item='header-nav-list']";var $menuList=(0,_veamsQuery2.default)(headerMenuList);if($target.hasClass(openClass)){$target.removeClass(openClass);$menuList.removeClass(openClass);}else{$target.addClass(openClass);$menuList.addClass(openClass);}});});exports.App=App;exports.Veams=_veams2.default;
